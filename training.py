...
def train_model(dataset, model, optimizer, num_epochs, scheduler=None):
    losses = []
    for epoch in range(num_epochs):
        ...
        print(
            f'epoch {epoch} loss:\t {average_train_loss} \t accuracies: \t train: {average_train_accuracy}\t valid: {average_valid_accuracy}')
        dataset.shuffle()
